...
if (to_file==1) {
  png(filename="unanimity.png", height=600, width=800, 
   bg="white")
  # postscript("fig1.eps")
} else {
...
data_majority <- read.table("unanimity-rate.dat", header=T, sep=" ")
...
title(xlab="Ensemble Size", cex.lab=1.5) #, col.lab=rgb(0,0.5,0)
title(ylab="Unanimity (%)", cex.lab=1.5) #col.lab=rgb(0,0.5,0)
